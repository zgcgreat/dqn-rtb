...
class environment:
    ...
    def step(self, action_index):
        ...
        """CONSIDER WHICH ACTIONS ARE NECESSARY, E.G. REGULATIONS AND TIME STEPS
        ARE JUST INVERSELY PROPORTIONAL."""
        ...
        if ((self.time_step == self.episode_length) or
        (len(self.ctr_estimations) < self.step_length)):
            self.termination = True
