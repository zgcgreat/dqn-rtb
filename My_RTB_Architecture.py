...
class e_greedy_policy:
    ...
    """
    def __init__(self, epsilon_max, epsilon_min, epsilon_decay_rate, q_estimator):
...
class agent:
    ...
    def __init__(self, epsilon_max, epsilon_min, epsilon_decay_rate, 
        ...
        self.e_greedy_policy = e_greedy_policy(self.epsilon_max, self.epsilon_min,
                                               self.epsilon_decay_rate, self.q_estimator)
...
for i in camp_n:
    for j in data_type:
        imported_files.append(open(os.path.join\
                            ('C:\\Users\oskst\OneDrive\Skrivbord\Python\\iPinYou_data', 
                             j+'_'+i+'.txt')))
